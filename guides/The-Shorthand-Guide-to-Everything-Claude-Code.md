...
> **@cogsec ([@affaanmustafa](https://x.com/affaanmustafa))** - 2025年9月16日
>
...
![Hackathon Photo 1](images/hackathon-1.jpg)
![Hackathon Photo 2](images/hackathon-2.jpg)
![Hackathon Photo 3](images/hackathon-3.jpg)
![Hackathon Photo 4](images/hackathon-4.jpg)
...
![chaining commands together](images/chaining-commands.jpg)
...
![Example of what feedback you get in Claude Code, while running a PostToolUse hook](images/post-tool-use-hook.png)
...
![Example of the supabase mcp listing the tables within the public schema](images/supabase-mcp.jpg)
...
![using /plugins to navigate to MCPs to see which ones are currently installed and their status](images/plugins-mcps.jpg)
...
![displaying the newly installed Mixedbread-Grep marketplace](images/mgrep-marketplace.jpg)
...
![claude approving a bug fix PR](images/github-actions-pr.jpg)
...
![Zed Editor with custom commands dropdown using CMD+Shift+R. Following mode shown as the bullseye in the bottom right.](images/zed-editor.jpg)
...
![from the docs directly at https://code.claude.com/docs/en/vs-code](images/vscode-extension.jpg)
...
![example statusline in my Mac root directory](images/statusline.jpg)
